...
def load_output_data(dataset, shuffle_index=None, shuffle_all_index=None, count_filter=None, balance_all_libraries=False):
	#############
	# LOAD DATA #
	#############
	...
	constant_test_set_split = 40000#120000
	...
	if use_cache == False :
		...
		Y = Y[((F_aataaa == 1) & (F_dpas_aataaa == 0)) & (F_denovo == 0),:]
		L = L[((F_aataaa == 1) & (F_dpas_aataaa == 0)) & (F_denovo == 0)]
		c = c[((F_aataaa == 1) & (F_dpas_aataaa == 0)) & (F_denovo == 0)]
		...
		if balance_all_libraries == True :
			...
			L_included = [22]#[2, 5, 8, 11, 20, 22, 30, 31, 34]#[22]#[2, 5, 8, 11, 20, 22, 30, 31, 34]#[22]#[2, 5, 8, 11, 20, 22, 30, 31, 32, 33, 34, 35]#[2, 5, 8, 11, 20, 22, 30, 31, 34]#[20]#[2, 5, 8, 11, 20, 22, 30, 31, 34]#[2, 5, 11, 20, 22, 31, 32, 33, 35]#[2, 5, 8, 11, 20, 22, 30, 31, 32, 33, 34, 35]#[2, 5, 8, 11, 20, 22, 30, 31, 34]#[2, 5, 11, 20, 22, 31]#[2, 5, 8, 11, 20, 22, 30, 31, 34]#[2, 5, 8, 11, 20, 22, 30, 31, 32, 33, 34, 35]#[2, 5, 8, 11, 20, 22, 30, 31, 32, 33, 34, 35]#[2, 5, 8, 11, 20, 22, 30, 31, 34]#[20]#[20]#[2, 5, 8, 11]#[22]#[20]#[2, 5, 8, 11, 20, 22, 30, 31, 32, 33, 34, 35]#[2, 5, 8, 11, 20, 22, 30, 31, 34]#[20]#[2, 5, 8, 11, 20, 22, 30, 31, 32, 33, 34, 35]#[20]#[2, 5, 8, 11, 20]#, 22]#[20, 22]
...
def load_input_data(dataset, shuffle=False, shuffle_all=False, count_filter=None, balance_all_libraries=False):
	#############
	# LOAD DATA #
	#############
	...
	if use_cache == False :
		...
		#L = L[(F_aataaa == 1) & (F_dpas_aataaa == 0)]
		#c = c[(F_aataaa == 1) & (F_dpas_aataaa == 0)]
		X = X[((F_aataaa == 1) & (F_dpas_aataaa == 0)) & (F_denovo == 0),:]
		L = L[((F_aataaa == 1) & (F_dpas_aataaa == 0)) & (F_denovo == 0)]
		c = c[((F_aataaa == 1) & (F_dpas_aataaa == 0)) & (F_denovo == 0)]
		d_input = d_input[((F_aataaa == 1) & (F_dpas_aataaa == 0)) & (F_denovo == 0),:]
		...
		if balance_all_libraries == True :
			...
			#List of included libraries
			L_included = [22]#[2, 5, 8, 11, 20, 22, 30, 31, 34]#[22]#[2, 5, 8, 11, 20, 22, 30, 31, 34]#[22]#[2, 5, 8, 11, 20, 22, 30, 31, 32, 33, 34, 35]#[2, 5, 8, 11, 20, 22, 30, 31, 34]#[20]#[2, 5, 8, 11, 20, 22, 30, 31, 34]#[2, 5, 11, 20, 22, 31, 32, 33, 35]#[2, 5, 8, 11, 20, 22, 30, 31, 32, 33, 34, 35]#[2, 5, 8, 11, 20, 22, 30, 31, 34]#[2, 5, 11, 20, 22, 31]#[2, 5, 8, 11, 20, 22, 30, 31, 32, 33, 34, 35]#[2, 5, 8, 11, 20, 22, 30, 31, 32, 33, 34, 35]#[2, 5, 8, 11, 20, 22, 30, 31, 34]#[20]#[20]#[2, 5, 8, 11]#[22]#[20]#[2, 5, 8, 11, 20, 22, 30, 31, 32, 33, 34, 35]#[2, 5, 8, 11, 20, 22, 30, 31, 34]#[20]#[2, 5, 8, 11, 20, 22, 30, 31, 32, 33, 34, 35]#[20]#[2, 5, 8, 11, 20]#, 22]#[20, 22]
		...
		rval = [train_set_x, valid_set_x, test_set_x, shuffle_index, train_set_L, valid_set_L, test_set_L, None, train_set_d, valid_set_d, test_set_d, shuffle_all_index]
